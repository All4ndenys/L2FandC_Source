...
public class ForumReward
{
	public static void main(String[] args) 
	{
		try {
			...
			String myUrl = "jdbc:mysql://193.124.0.113/amazons_forum";
			Class.forName(myDriver);
			Connection conn = DriverManager.getConnection(myUrl, "amazonforum", "AmazonsForumReward100200!#%");
