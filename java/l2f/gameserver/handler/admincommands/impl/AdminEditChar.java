...
public class AdminEditChar implements IAdminCommandHandler
{
	...
	public static void showCharacterList(Player activeChar, Player player)
	{
		...
		replyMSG.append("<tr><td width=100><font color=0099FF>Server ID:</font></td><td>" + player.getNetConnection().getServerId() + "</td></tr>");
		replyMSG.append("<tr><td width=100><font color=0099FF>Proxy:</font></td><td>" + player.getProxyIP() + "</td></tr>");
