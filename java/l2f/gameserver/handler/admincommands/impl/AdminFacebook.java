		...
		switch (command)
		{
			case admin_facebook:
			{
				...
				for (CompletedTask task : CompletedTasksHistory.getInstance().getTasksThatNeedsApproval())
				{
					...
					sb.append("<br>");
					sb.append("<button value=\"Approve\" action=\"bypass -h admin_fb_set_message_approval " + task.getId() + " True\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\" />");
					sb.append("<br>");
					sb.append("<button value=\"NOT Approve\" action=\"bypass -h admin_fb_set_message_approval " + task.getId() + " False\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\" />");
					sb.append("</td>");
					sb.append("</tr>");
					sb.append("</table>");
					sb.append("</td>");
			...
			case admin_fb_official_posts:
			{
				...
				for (OfficialPost officialPost : OfficialPostsHolder.getInstance().getRecentOfficialPostsForIterate())
				{
					...
					sb.append("<br><br><br>");
					sb.append("<button value=\"Setup\" action=\"bypass -h admin_fb_official_post_edit_panel " + officialPost.getId() + "\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\" />");
					sb.append("</td>");
					sb.append("</tr>");
					sb.append("</table>");
					sb.append("</td>");
			...
			case admin_fb_official_post_edit_panel:
			{
				...
				for (FacebookActionType actionType : FacebookActionType.values())
				{
					...
					if (officialPost.isActionTypeRewarded(actionType))
						sb.append("<button value=\"" + actionType.toString() + "\" action=\"bypass -h admin_fb_remove_rewarded_action " + officialPost.getId() + " " + actionType.toString() + "\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\" />");
					else
						sb.append("<button value=\"" + actionType.toString() + "\" action=\"bypass -h admin_fb_add_rewarded_action " + officialPost.getId() + " " + actionType.toString() + "\" width=100 height=28 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_ct1.Button_DF\" />");
				}
