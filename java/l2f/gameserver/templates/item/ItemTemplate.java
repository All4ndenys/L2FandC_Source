...
public abstract class ItemTemplate extends StatTemplate
{
	...
	public boolean isVesperItem()
	{
		return _name.contains("Vesper");
	}
	
	public boolean isVorpalItem()
	{
		return _name.contains("Vorpal");
	}
	
	public boolean isElegiaItem()
	{
		return _name.contains("Elegia");
	}
