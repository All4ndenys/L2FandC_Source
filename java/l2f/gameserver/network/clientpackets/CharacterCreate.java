...
public class CharacterCreate extends L2GameClientPacket
{
	...
	private void initNewChar(GameClient client, Player newChar)
	{
		...
		/*System.out.println("ServiceRate Type: " + Config.SERVICES_RATE_TYPE + " ServiceRateCreatePA :" + Config.SERVICES_RATE_CREATE_PA + "Bonus : " + newChar.hasBonus());
		System.out.println("Calculator: " + (int)(System.currentTimeMillis() / 1000L * (60 * 60 * 24 *  Config.SERVICES_RATE_CREATE_PA)) );
		if (Config.SERVICES_RATE_TYPE != Bonus.NO_BONUS && Config.SERVICES_RATE_CREATE_PA != 0 && !newChar.hasBonus())
		{
			System.out.println("Enter first step");
		...
		// claw - Support to gifting a premium service to the player when creating a new char
