...
import l2f.gameserver.network.clientpackets.security.AbstractBypassPacket;
...
{
	private static String[] ScriptBypassesFilterWords = {"util", "events", "services", "handler", "zones", "actions"};
	//Format: cS
