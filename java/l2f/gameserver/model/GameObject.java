...
public abstract class GameObject extends EventOwner
{
	 ...
	 * Do not confuse with deleteMe. The object after decayMe is re-rendered via spawnMe.
	 * If you mistake a memory leak.
	 */
	...
	/**
	 * Removes an object from the world. After that, the object is not usable.
	 */
