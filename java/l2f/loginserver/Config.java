...
public class Config
{
	...
	public static boolean ENABLE_PROXIES;
	public static int FakeOnlineInLoginForL2Net;
	...
	public static final void loadConfiguration()
	{
		...
		ENABLE_PROXIES = serverSettings.getProperty("OldProxiesEnabled", false);
		FakeOnlineInLoginForL2Net = serverSettings.getProperty("FakeOnline", 1);
